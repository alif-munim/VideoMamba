...
JOB_NAME='videomamba_middle_f32_res224_pt10'
...
python run_regression_finetuning_cedar.py \
    --model videomamba_middle \
    --finetune '/scratch/alif/VideoMamba/videomamba/video_sm/exp/k400/videomamba_middle_mask/videomamba_middle_mask_echo_pt_f8_res384/checkpoint-latest.pth' \
    --data_path ${DATA_PATH} \
    --prefix ${PREFIX} \
    --data_set 'ECHO' \
    --split ',' \
